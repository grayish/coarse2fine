...
from .annotation_old import annotations, OldAnnotation as Annotation
from .task_old import tasks, OldTask as Task


class OldHuman36m(torch_data.Dataset):
    def __init__(self, image_path, subjects, task, joints,
        ...
        for z_res in self.voxel_z_res_list:
            vx = torch.zeros(self.joints, int(z_res), self.voxel_xy_res, self.voxel_xy_res)
    ...
    def preprocess(self, raw_data):
        ...
        return F.to_tensor(image), voxels, camera, sequence
